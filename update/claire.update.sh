...
gum spin --spinner dot --title "Updating claire.menu" -- bash -c "git clone -b main --single-branch https://git.waystid.dev/waystid/claire-menu.git /opt/claire/claire.menu2"
